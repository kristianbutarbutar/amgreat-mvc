...
<head>
	...
	<link rel="stylesheet" href="./css/main.css" token="" id="">
	<link rel="stylesheet" href="./css/face.css" token="" id="">
	<script src="./js/jquery-3.7.1.min.js"></script>
	<script src="./js/main.js" token="" id=""></script>
	<style>
...
<body>
		...
		<div class="container h-9 mobilesize p-6" id="CL2">
			<div class="col-5 m-2 mobile b1" id="col-4">
				<div class="box-85 h-9 m-2 p-8overflow">
					testscvs
				</div>
			</div>
...
<script type="text/javascript">
	...
	var __data = { pageId:"DDYGPGTPNWQEYIVJPFCVJQGSXGSQYVMCKVRVSKYNKWEWHPLGWG" };
	var __url = "http://localhost:8091/amgreate/api/int/fe";
	var __fmobile = () => {
			console.log(" executed __fmobile ");
			 $.ajax({ url : __url, dataType:'json', type: "POST", timeout: 15000, data : __data,

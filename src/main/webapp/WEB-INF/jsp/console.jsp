...
<head>
	...
	<title>[[TITLE]]</title>
	<link rel="icon" href="http://localhost:8091/svg/amgreat.jpeg" />
	<link rel="stylesheet" href="http://localhost:8091/css/main-2.css" token="" id="">
	...
	<script src="http://localhost:8091/js/main-2.js" token="" id=""></script>
	<style>
		...
		.linkcss, .mnlinkcss { cursor:pointer;}
		.linkcss:before, .mnlinkcss:before { content:"\a0";}
		.inoverflow{ overflow: auto; }
		.mnlinkparentcss > img, .mnlinkparentcss > div {display:inline-block;white-space:normal;vertical-align:middle;} 
		.linkparentcss > img, .linkparentcss > div {display:inline-block;white-space:normal;vertical-align:middle;}
...
<div class="container b1" id="CL1" style="z-index:17;margin:auto;">
	<div class="col-1">
		<div class="container-80 h-05 " id="CL1" style="z-index:17;margin:auto;">
			<div class="col-5 txr ptr top-hamb p-8">
				<div class="hambbox" targetpop="__popup" actiongo="__fshow" params="(this, event)" >
			...
			<div class="col-5 txr" id="__r1c4" style="z-index:17;">
				<div class="linkurigrp mobile p-6">
		...
		<div class="container h-03 mobile" id="CL2"><div class="col-1" id="col-4">&nbsp;</div></div>	
		
		<div class="container-80 h-9 mobilesize p-6" style="margin:auto;" id="CL2">
			<div class="col-4 m-0 mobile b1" id="col-4">
				<div class="box-100 h-9 m-2 p-8 inoverflow" id="_me_"></div>
			</div>
			<div class="col-70 m-0 mt-0 h-10" id="__content" style="margin:auto;">[[CONTENT]]</div>
		</div>
...
<script type="text/javascript">
	...
	var __data = { pageId:"amgreatappsid", url:"http://localhost:8091/amgreate/api/int/fe"};
	
	var __fsetHtml = ( __id, __o ) => {
		for (var idx in __o.rows ) { document.getElementById( __id ).innerHTML += __o.rows[idx].row ; }
	};
	
	var __fmobile = ( __data__, __faction, __id__ ) => {
			 $.ajax({ headers: { 'Accept': 'application/json', 'Content-Type': 'application/json; charset=UTF-8' }, 
			 	url : __data__.url, dataType:'json', type: "POST", timeout: 15000, data : JSON.stringify(__data__),
			    success: function( data, textStatus, jqXHR)
			    { __faction( __id__, data ); },
			    error: function (jqXHR, textStatus, errorThrown)
			    { console.log( JSON.stringify(errorThrown) ); } }); 
	};
	
	var __fonload = () => {
		__data = { pageId:"amgreatappsid",url:"http://localhost:8091/amgreate/api/int/fe"}; __fmobile( __data, __fsetHtml, "_me_" );
		__data = { pageId:"t_form_list_1",url:"http://localhost:8091/amgreate/api/int/fe"}; __fmobile( __data, __fsetHtml, "_me_" );
	}; __fonload();
	
	var __fpages = (__param) => {
		__data = { pageId:"amgreatappsid", url:"http://localhost:8091/amgreate/api/int/fe" }; __fmobile( __data, __fsetHtml, "_me_" );
	};
	
	var __fpaged = (_p1) => { window.open(_p1, '_self'); };
